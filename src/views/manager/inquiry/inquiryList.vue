<template>
  <div class="main-content">
    ...
    <eb-table :list="list" :columns="columns">
      ...
      <el-table-column slot="opt" label="操作" width="80">
        <el-button size="mini" type="text" slot-scope="{ row }" @click="showDetail(row)">查看</el-button>
      </el-table-column>
    </eb-table>
...
export default {
  data() {
    return {
      ...
      list: [],
      columns: [
        { prop: "inquiryId", label: "ID", width:50,},
        { slot: 'img' },
        { prop: "createTime", label: "发布时间", width:130,},
        ...
        { prop: "confirmedCount", label: "确认数", width:60 },
